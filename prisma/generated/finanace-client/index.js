...
if (!fs.existsSync(path.join(__dirname, 'schema.prisma'))) {
  const alternativePaths = [
    "prisma/generated/finanace-client",
    "generated/finanace-client",
  ]
...
path.join(process.cwd(), "prisma/generated/finanace-client/query_engine-windows.dll.node")
// file annotations for bundling tools to include these files
path.join(__dirname, "schema.prisma");
path.join(process.cwd(), "prisma/generated/finanace-client/schema.prisma")
