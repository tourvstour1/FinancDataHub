...
-- DropForeignKey
ALTER TABLE "public"."t_adp" DROP CONSTRAINT "t_adp_seq_fkey";

-- DropForeignKey
ALTER TABLE "public"."t_odx" DROP CONSTRAINT "t_odx_seq_fkey";

-- DropForeignKey
ALTER TABLE "public"."t_orf" DROP CONSTRAINT "t_orf_seq_fkey";
