...
*/
-- DropForeignKey
ALTER TABLE "public"."t_ipd" DROP CONSTRAINT "t_ipd_t_insId_fkey";
...
-- CreateIndex
CREATE UNIQUE INDEX "t_ins_seq_key" ON "t_ins"("seq");
...
-- AddForeignKey
ALTER TABLE "t_opd" ADD CONSTRAINT "t_opd_seq_fkey" FOREIGN KEY ("seq") REFERENCES "t_ins"("seq") ON DELETE RESTRICT ON UPDATE CASCADE;
