...
-- AddForeignKey
ALTER TABLE "t_opd" ADD CONSTRAINT "t_opd_hn_fkey" FOREIGN KEY ("hn") REFERENCES "t_pat"("hn") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "t_ipd" ADD CONSTRAINT "t_ipd_t_insId_fkey" FOREIGN KEY ("t_insId") REFERENCES "t_ins"("id") ON DELETE SET NULL ON UPDATE CASCADE;
