/*
  ...
  - You are about to drop the `_t_adpTot_opd` table. If the table is not empty, all the data it contains will be lost.
  - You are about to drop the `_t_insTot_ipd` table. If the table is not empty, all the data it contains will be lost.
  - You are about to drop the `_t_insTot_opd` table. If the table is not empty, all the data it contains will be lost.
  - You are about to drop the `_t_ipdTot_pat` table. If the table is not empty, all the data it contains will be lost.
  - You are about to drop the `_t_odxTot_opd` table. If the table is not empty, all the data it contains will be lost.
  - You are about to drop the `_t_opdTot_orf` table. If the table is not empty, all the data it contains will be lost.
  - You are about to drop the `_t_opdTot_pat` table. If the table is not empty, all the data it contains will be lost.
...
*/
-- DropForeignKey
ALTER TABLE "public"."_t_adpTot_opd" DROP CONSTRAINT "_t_adpTot_opd_A_fkey";

-- DropForeignKey
ALTER TABLE "public"."_t_adpTot_opd" DROP CONSTRAINT "_t_adpTot_opd_B_fkey";

-- DropForeignKey
ALTER TABLE "public"."_t_insTot_ipd" DROP CONSTRAINT "_t_insTot_ipd_A_fkey";

-- DropForeignKey
ALTER TABLE "public"."_t_insTot_ipd" DROP CONSTRAINT "_t_insTot_ipd_B_fkey";

-- DropForeignKey
ALTER TABLE "public"."_t_insTot_opd" DROP CONSTRAINT "_t_insTot_opd_A_fkey";

-- DropForeignKey
ALTER TABLE "public"."_t_insTot_opd" DROP CONSTRAINT "_t_insTot_opd_B_fkey";

-- DropForeignKey
ALTER TABLE "public"."_t_ipdTot_pat" DROP CONSTRAINT "_t_ipdTot_pat_A_fkey";

-- DropForeignKey
ALTER TABLE "public"."_t_ipdTot_pat" DROP CONSTRAINT "_t_ipdTot_pat_B_fkey";

-- DropForeignKey
ALTER TABLE "public"."_t_odxTot_opd" DROP CONSTRAINT "_t_odxTot_opd_A_fkey";

-- DropForeignKey
ALTER TABLE "public"."_t_odxTot_opd" DROP CONSTRAINT "_t_odxTot_opd_B_fkey";

-- DropForeignKey
ALTER TABLE "public"."_t_opdTot_orf" DROP CONSTRAINT "_t_opdTot_orf_A_fkey";

-- DropForeignKey
ALTER TABLE "public"."_t_opdTot_orf" DROP CONSTRAINT "_t_opdTot_orf_B_fkey";

-- DropForeignKey
ALTER TABLE "public"."_t_opdTot_pat" DROP CONSTRAINT "_t_opdTot_pat_A_fkey";

-- DropForeignKey
ALTER TABLE "public"."_t_opdTot_pat" DROP CONSTRAINT "_t_opdTot_pat_B_fkey";

-- DropTable
DROP TABLE "public"."_t_adpTot_opd";

-- DropTable
DROP TABLE "public"."_t_insTot_ipd";

-- DropTable
DROP TABLE "public"."_t_insTot_opd";

-- DropTable
DROP TABLE "public"."_t_ipdTot_pat";

-- DropTable
DROP TABLE "public"."_t_odxTot_opd";

-- DropTable
DROP TABLE "public"."_t_opdTot_orf";

-- DropTable
DROP TABLE "public"."_t_opdTot_pat";
...
-- CreateTable
CREATE TABLE "_t_opdTot_orf" (
    "A" TEXT NOT NULL,
    "B" TEXT NOT NULL
);

-- CreateTable
CREATE TABLE "_t_odxTot_opd" (
    "A" TEXT NOT NULL,
    "B" TEXT NOT NULL
);
...
-- CreateIndex
CREATE UNIQUE INDEX "_t_opdTot_orf_AB_unique" ON "_t_opdTot_orf"("A", "B");

-- CreateIndex
CREATE INDEX "_t_opdTot_orf_B_index" ON "_t_opdTot_orf"("B");

-- CreateIndex
CREATE UNIQUE INDEX "_t_odxTot_opd_AB_unique" ON "_t_odxTot_opd"("A", "B");

-- CreateIndex
CREATE INDEX "_t_odxTot_opd_B_index" ON "_t_odxTot_opd"("B");
...
-- CreateIndex
CREATE UNIQUE INDEX "_t_adpTot_opd_AB_unique" ON "_t_adpTot_opd"("A", "B");

-- CreateIndex
CREATE INDEX "_t_adpTot_opd_B_index" ON "_t_adpTot_opd"("B");
...
-- AddForeignKey
ALTER TABLE "_t_opdTot_orf" ADD CONSTRAINT "_t_opdTot_orf_A_fkey" FOREIGN KEY ("A") REFERENCES "t_opd"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "_t_opdTot_orf" ADD CONSTRAINT "_t_opdTot_orf_B_fkey" FOREIGN KEY ("B") REFERENCES "t_orf"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "_t_odxTot_opd" ADD CONSTRAINT "_t_odxTot_opd_A_fkey" FOREIGN KEY ("A") REFERENCES "t_odx"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "_t_odxTot_opd" ADD CONSTRAINT "_t_odxTot_opd_B_fkey" FOREIGN KEY ("B") REFERENCES "t_opd"("id") ON DELETE CASCADE ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "_t_adpTot_opd" ADD CONSTRAINT "_t_adpTot_opd_A_fkey" FOREIGN KEY ("A") REFERENCES "t_adp"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "_t_adpTot_opd" ADD CONSTRAINT "_t_adpTot_opd_B_fkey" FOREIGN KEY ("B") REFERENCES "t_opd"("id") ON DELETE CASCADE ON UPDATE CASCADE;
